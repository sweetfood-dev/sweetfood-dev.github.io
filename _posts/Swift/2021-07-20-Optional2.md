...
![](http://localhost:4000/assets/images/Posts/Swift/optional.png)
...
![](http://localhost:4000/assets/images/Posts/Swift/Optional_if.png)
if 문에서 nil 이 아닐 때 print가 실행이 된다. 그럼 print가 되었을때 옵셔널 변수의 값은 어떨까?<br>
![<br>](http://localhost:4000/assets/images/Posts/Swift/Optional_if2.png)
...
![](http://localhost:4000/assets/images/Posts/Swift/Optional_if3.png)
